...
export type Normal_Dictionary<T extends p_di.Value> = p_di.Dictionary<T>
export type Normal_List<T extends p_di.Value> = p_di.List<T>
...
export const dictionary = <T extends p_di.Value>($: Normal_Dictionary<T>): p_di.Dictionary<T> => {
    return $
}


export const list = <T extends p_di.Value>($: Normal_List<T>): p_di.List<T> => {
    return $
}
